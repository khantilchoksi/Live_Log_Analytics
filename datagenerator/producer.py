...
possible_errors = ['404','200','302','505']
possible_range = [(100,200),(300,400), (500,700),(700,1200), (1200,1800),(400,1200)]
...
try:
    while True:
        ...
        random_enpoint_index = random.randint(0, len(possible_endpoints)-1)

        data  = {
            'ip': current_record[0],
            'timestamp': current_record[1],
            'endpoint': possible_endpoints[random_enpoint_index],
            'response_code': possible_errors[random.randint(0, len(possible_errors)-1)],
            'response_time': random.randint(possible_range[random_enpoint_index][0], possible_range[random_enpoint_index][1])
        }
